...
Вариант подтверждён в [ведомости курса](https://docs.google.com/spreadsheets/d/1nHewCKHKgS9BqbfIv1GTuropMRdFEIDgqLwYDaufA-U/edit).
По [списку вариантов](https://docs.google.com/document/d/1Gn70MbwrJ7gJxTkafr5xWAzxEY9B9y2cP1e2-jzsF-8/edit) для следующих этапов назначены PostgreSQL и RabbitMQ.
...
Все пять запросов реализованы через LINQ непосредственно в unit-тестах: ветеринары выбранного вида животных; питомцы указанного врача по кличке; число повторных приёмов выбранной породы; владельцы нескольких питомцев по ФИО; приёмы текущего месяца в выбранном кабинете.

Для воспроизводимости «текущая дата» явно задаётся в тесте. Датасид сдвигает даты всех приёмов относительно этого месяца, сохраняя их идентификаторы и расположение до/внутри/после месяца. Поэтому одни и те же ожидаемые ID намеренно проверяются для сентября, декабря, обычного и високосного февраля. Месяц определяется интервалом от начала месяца включительно до начала следующего исключительно. Питомец с несколькими записями к одному врачу выводится один раз по его идентификатору; одинаковые клички разных питомцев сохраняются.

Исходные [условия предметной области](https://docs.google.com/document/d/1ZzvqCghe9LS444LyKmLdt3xH-T_Fp9grGw5rEEMMqRs/edit) и общие требования курса приведены ниже.
...
<br> 
В пятой лабораторной необходимо добавить в конфигурацию Aspire запуск клиентского приложения для написанного ранее сервера. Клиент создается в рамках курса "Веб разработка" либо реализуется в рамках лабораторных с использованием Blazor Web Assembly.
<br> 
</details>
...
[Список вариантов](https://docs.google.com/document/d/1Gn70MbwrJ7gJxTkafr5xWAzxEY9B9y2cP1e2-jzsF-8/edit?usp=sharing)  
[Список предметных областей](https://docs.google.com/document/d/1ZzvqCghe9LS444LyKmLdt3xH-T_Fp9grGw5rEEMMqRs/edit?usp=sharing)  
[Вопросы к экзамену](https://docs.google.com/document/d/1rIo0Vp0o1mSQoYEzKcKa4u1xm2BNieZQYcITJkH9TSY/edit?usp=sharing)
